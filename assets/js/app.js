...
!(function(a, b) {
    ...
    var d = [].slice
      ...
      , i = function(a, d, e, f) {
        var g, h = !1, i = !1, j = "always" == f ? 0 : Date.now(), k = 0, l = (a || d).parentNode, m = function() {
            if (e) {
                var j = function(a) {
                    (h = !0),
                    g || (g = a.target),
                    ...
                    g && (g.removeEventListener("load", j),
                ...
                "always" != f && ((g.style.visibility = "hidden"),
                c.rAF(function() {
    ...
    a.addEventListener("lazybeforeunveil", function(a) {
        ...
        if (b.instance == c && b.blurUp) {
            ...
            i(e, d, h(e, d) || "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", b.blurUp)
        }
    }),
